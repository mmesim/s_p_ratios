...
%--------------------------------------------------
    ...
    dataZ(j)=struct('ID',str2double(splitfilename{1,1}),'waveform',D,'DELTA',header.DELTA, 'A', header.A, 'EVLA', header.EVLA, ...
    ...
    %------- add headers to a signle structure --------
    %Upadated to keep specific entries
    dataE(jj)=struct('ID',str2double(splitfilename{1,1}),'waveform',D,'DELTA',header.DELTA, 'T0', header.T0, 'EVLA', header.EVLA, ...
                   'EVLO',header.EVLO, 'EVDP', header.EVDP , ...
                    'MAG',header.MAG, 'NZYEAR',header.NZYEAR, 'NZJDAY',header.NZJDAY, ...
                    'STLA', header.STLA, 'STLO', header.STLO, 'STEL', header.STEL, ...
                    'KSTNM', header.KSTNM, 'KCMPNM', header.KCMPNM , 'KNETWK', header.KNETWK );
    ...
    %------- add headers to a signle structure --------
    %Upadated to keep specific entries
    dataN(jjj)=struct('ID',str2double(splitfilename{1,1}),'waveform',D,'DELTA',header.DELTA, 'T0', header.T0, 'EVLA', header.EVLA, ...
                   'EVLO',header.EVLO, 'EVDP', header.EVDP , ...
                    'MAG',header.MAG, 'NZYEAR',header.NZYEAR, 'NZJDAY',header.NZJDAY, ...
                    'STLA', header.STLA, 'STLO', header.STLO, 'STEL', header.STEL, ...
                    'KSTNM', header.KSTNM, 'KCMPNM', header.KCMPNM , 'KNETWK', header.KNETWK );
